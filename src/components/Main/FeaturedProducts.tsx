    ...
    <section id="products" className="flex-1 px-4 md:px-8 py-8 flex-col flex items-center justify-center max-w-7xl mx-auto ">
      ...
      >            <div className="flex flex-col items-center justify-center md:w-1/2">
          <Link href="/products/1">
            <Image 
              src="/Product_Images/PC1_img.webp" 
              alt="Gaming Desktop" 
              width={320}
              height={320}
              className="w-80 object-cover rounded-lg bg-gray-700 shadow-md hover:opacity-90 transition-opacity" 
            />
          </Link>
        </div>
      ...
      >        <div className="flex flex-col items-center justify-center md:w-1/2">
            <Link href="/products/6">
              <Image 
                src="/Product_Images/Laptop1_img.webp" 
                alt="Gaming Laptop" 
                width={320}
                height={320}
                className="w-80 object-cover rounded-lg bg-gray-700 shadow-md hover:opacity-90 transition-opacity" 
      ...
      >            <div className="flex flex-col items-center justify-center md:w-1/2">
          <Link href="/products/11">
            <Image 
              src="/Product_Images/Keyboard1_img.jpg" 
              alt="Gaming Keyboard" 
              width={500}
              height={300}
              className="w-full object-cover rounded-lg bg-gray-700 shadow-md hover:scale-105 transition duration-300" 
            />
          </Link>
        </div>
        <div className="md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left">            
